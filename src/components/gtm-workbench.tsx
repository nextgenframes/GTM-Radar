...
function Card({
  ...
  return (
    <motion.section
      ...
      className="rounded-[1.5rem] border border-slate-200 bg-white p-5 shadow-xl shadow-slate-200/50 backdrop-blur dark:border-white/10 dark:bg-white/[0.055] dark:shadow-black/15"
    >
...
export function GtmWorkbench({ type, title, description, placeholder }: WorkbenchProps) {
  ...
  return (
    <div className="space-y-6">
      <form onSubmit={handleSubmit} className="rounded-[2rem] border border-slate-200 bg-white/80 p-5 shadow-2xl shadow-slate-200/60 backdrop-blur dark:border-white/10 dark:bg-slate-950/60 dark:shadow-black/20">
      ...
      {!result && !error && !isLoading ? (
        <div className="rounded-[1.5rem] border border-dashed border-slate-300 dark:border-white/15 bg-white/70 dark:bg-white/[0.035] p-8 text-center">
